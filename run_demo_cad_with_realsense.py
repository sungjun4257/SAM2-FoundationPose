...
#   color = cv2.imread("/media/vision/data_4TB/hyundai/data_0224/10_color.png")
#   depth = cv2.imread("/media/vision/data_4TB/hyundai/data_0224/10_depth.png", -1)

#   color = cv2.imread("/media/vision/data_4TB/hyundai/data_0317/0_color.png")
#   depth = cv2.imread("/media/vision/data_4TB/hyundai/data_0317/0_depth.png", -1)
...
# 
#   color = cv2.imread("/media/vision/data_4TB/hyundai/data_0224/0_color.png")
#   depth = cv2.imread("/media/vision/data_4TB/hyundai/data_0224/0_depth.png", -1)
...
def get_mask(color, depth, text_prompt):
  # cfg
...
#   mesh.sample_points_uniformly(number_of_points=args.num_point)
  ...
  while True:
    ...
    if i==0:
      ...
      mask = get_mask(color, depth,args.text_prompt)
