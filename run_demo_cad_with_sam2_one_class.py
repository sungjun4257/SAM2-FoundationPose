...
#   color = cv2.imread("/home/vision/packages/camera/realsense/data/0_color.png")
#   depth = cv2.imread("/home/vision/packages/camera/realsense/data/0_depth.png",-1) 
  
#   color = cv2.imread("result/masked_color.png")
#   depth = cv2.imread("logs/2025-09-12_17-40-56/depth.png",-1) 
...
#   mesh.sample_points_uniformly(number_of_points=args.num_point)
  ...
  while True:
    ...
    #   mask = get_mask_grounded(color, depth,args.text_prompt)
      mask = get_mask_grounded_sam2(color,depth, args.text_prompt)
